...
import { recommendOutfit } from "../utils/recommend.js";
...
function buildSuggestionMessage(weather, item, dayPhrase) {
...
export const getDailySuggestion = async (req, res) => {
    ...
    const occasion = dayPhrase.includes("weekend") || dayPhrase === "Sunday" ? "casual" : "work";
